...
LOCAL_MODULE := audio.primary.mt6735
...
#LOCAL_LDFLAGS += -L$(LOCAL_PATH)/../../../../vendor/mediatek/mt6795/lib/ -laudio.primary.default
LOCAL_SHARED_LIBRARIES := libdl libcutils liblog libutils libbinder

include $(BUILD_SHARED_LIBRARY)

LIBORIG := $(LOCAL_INSTALLED_MODULE)
LIBLINK1 := $(subst audio.primary.mt6735,audio.primary.default,$(LIBORIG))
$(LIBLINK1): $(LIBORIG)
	@echo "Symlink: $@ -> $(notdir $<)"
	@mkdir -p $(dir $@)
	$(hide) ln -sf $(notdir $<) $@
